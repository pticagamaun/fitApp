...
extension UIColor {
    ...
    static let specialGreen = #colorLiteral(red: 0.2431372549, green: 0.6156862745, blue: 0.5647058824, alpha: 1)
    static let specialYellow = #colorLiteral(red: 0.9963226914, green: 0.8627573252, blue: 0.4291374087, alpha: 1)
    static let specialDarkGreen = #colorLiteral(red: 0.1411764706, green: 0.2941176471, blue: 0.262745098, alpha: 1)
    static let specialLine = #colorLiteral(red: 0.761189878, green: 0.7422975898, blue: 0.6815395951, alpha: 1)
    static let specialBackgroundCell = #colorLiteral(red: 0.9019607843, green: 0.8823529412, blue: 0.8196078431, alpha: 1)
    static let specialLightBrown = #colorLiteral(red: 0.9411764706, green: 0.9294117647, blue: 0.8862745098, alpha: 1)
